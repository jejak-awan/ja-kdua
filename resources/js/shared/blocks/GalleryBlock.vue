...
const captionPosition = computed(() => getVal(settings.value, 'captionPosition', props.device) || 'overlay')
const hoverEffect = computed(() => getVal(settings.value, 'hoverEffect', props.device) || 'zoom')
