...
/**
 * Lottie Animation Module Definition (Divi 5 Reference)
 */
export default {
    name: 'lottie',
        ...
        content: [
            {
                ...
                fields: [
                    ...
                    { name: 'animationUrl', type: 'text', label: 'Animation URL' },
                    { name: 'animationJson', type: 'textarea', label: 'Animation JSON' }
                ]
            },
            {
                id: 'playback',
