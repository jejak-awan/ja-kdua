...
export const flexMultiRowPresets = [
    // Row 1
...
export const flexMultiColumnPresets = [
...
export const gridMultiRowPresets = [...flexMultiRowPresets]

export const masonryPresets = [
    // Row 1 (from image)
