        ...
        >
            ...
            >
                <button
                    v-if="showBackToTop"
                    @click="scrollToTop"
                    class="absolute bottom-4 right-4 z-10 w-9 h-9 bg-primary text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group"
                    title="Back to Top"
                >
