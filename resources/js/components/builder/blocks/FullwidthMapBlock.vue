<template>
  <div class="fullwidth-map-block" :style="wrapperStyles">
    <div class="map-container" :style="containerStyles">
      ...
      <!-- Child Pins (Simulated) -->
      <div v-for="(pin, index) in childPins" :key="index" class="map-marker-label" :style="{ top: `${20 + index * 40}px`, left: '20px' }">
         <MapPin class="marker-icon" />
