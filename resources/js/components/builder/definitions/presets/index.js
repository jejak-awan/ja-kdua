...
import { spacingSettings, spacingDefaults } from './spacing';
import { backgroundSettings, backgroundDefaults } from './background';
import { borderSettings, borderDefaults } from './border';
import { effectsSettings, effectsDefaults } from './effects';
import { positionSettings, positionDefaults } from './position';
...
export const textComponentDefaults = {
    ...typographyDefaults
};
...
export const imageComponentDefaults = {
    src: '',
    alt: '',
    objectFit: 'cover',
    aspectRatio: 'auto',
...
export const buttonComponentSettings = [
...
export const buttonComponentDefaults = {
    text: 'Click Here',
    url: '#',
    openNewTab: false,
    variant: 'primary',
...
export const iconComponentDefaults = {
    iconName: 'star',
    iconSize: 24,
