    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'isp/outages',
                name: 'isp-outages',
                component: () => import('../views/Isp/Dashboard/Outages/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
            ...
            {
                path: 'isp/operations/deployments',
                name: 'isp-deployments',
                component: () => import('../views/Isp/Settings/Deployment.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/admin/analytics/usage',
                name: 'isp.admin.analytics.usage',
                component: () => import('../views/Isp/Dashboard/UsageDashboard.vue'),
            },
            {
            ...
            {
                path: 'isp/admin/analytics/coverage',
                name: 'isp.admin.analytics.coverage',
                component: () => import('../views/Isp/Dashboard/CoverageHeatmap.vue'),
            },
            {
                path: 'isp/admin/analytics/bi',
                name: 'isp-analytics-bi',
                component: () => import('../views/Isp/Billing/Analytics/BiDashboard.vue'),
                meta: { permission: 'manage isp' },
            },
            {
                path: 'isp/network/service-zones',
                name: 'isp-service-zones',
                component: () => import('../views/Isp/Network/ServiceZones.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/admin/health',
                name: 'isp-health-center',
                component: () => import('../views/Isp/Dashboard/HealthCenter.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/odp',
            ...
            },
            {
                path: 'isp/inventory',
                name: 'isp-inventory',
                component: () => import('../views/Isp/Hotspot/Stock.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/vouchers',
                name: 'isp-vouchers',
                component: () => import('../views/Isp/Hotspot/Vouchers.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/vouchers/sold',
                name: 'isp-vouchers-sold',
                component: () => import('../views/Isp/Hotspot/Sold.vue'),
            },
            {
                path: 'isp/vouchers/print/:batchId',
                name: 'isp.vouchers.print',
                component: () => import('../views/Isp/Hotspot/BatchPrint.vue'),
                meta: { layout: 'empty' }
            },
            {
                path: 'isp/partners',
                name: 'isp-partners',
                component: () => import('../views/Isp/Customer/Partner/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/coupons',
                name: 'isp-coupons',
                component: () => import('../views/Isp/Billing/Coupons.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/whatsapp',
                name: 'isp-whatsapp',
                component: () => import('../views/Isp/Settings/WhatsApp/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/print-templates',
                name: 'isp-print-templates',
                component: () => import('../views/Isp/Settings/PrintTemplates.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/tools/bgp',
                name: 'isp-bgp-toolkit',
                component: () => import('../views/Isp/Settings/Tools/BgpToolkit.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/admin/activity-logs',
                name: 'isp-activity-logs',
                component: () => import('../views/Isp/Dashboard/ActivityLogs.vue'),
                meta: { permission: 'manage settings' },
            },
            {
            ...
            },
            {
                path: 'isp/monitor',
                name: 'isp-monitor',
                component: () => import('../views/Isp/Dashboard/NocDashboard.vue'),
                meta: { permission: 'manage settings' }
            },
            {
                path: 'isp/monitor/traffic',
                name: 'isp.monitor.traffic',
                component: () => import('../views/Isp/Dashboard/TrafficMonitor.vue'),
                meta: { permission: 'manage settings' }
            },
            {
                path: 'isp/monitor/report',
                name: 'isp.monitor.report',
                component: () => import('../views/Isp/Dashboard/TrafficReport.vue'),
                meta: { permission: 'manage settings' }
            },
            {
                path: 'isp/monitoring/sessions',
                name: 'isp-active-sessions',
                component: () => import('../views/Isp/Dashboard/ActiveSessions.vue'),
                meta: { permission: 'manage settings' }
            },
            {
                path: 'isp/monitoring/radius/sessions',
                name: 'isp-radius-sessions',
                component: () => import('../views/Isp/Dashboard/RadiusSessions.vue'),
                meta: { permission: 'manage settings' }
            },
            {
                path: 'isp/monitoring/radius/logs',
                name: 'isp-radius-logs',
                component: () => import('../views/Isp/Dashboard/RadiusLogs.vue'),
                meta: { permission: 'manage settings' }
            },
            {
            ...
            },
            {
                path: 'isp/analytics',
                name: 'isp-analytics',
                component: () => import('../views/Isp/Billing/Analytics/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/hotspot',
                name: 'isp-hotspot',
                component: () => import('../views/Isp/Hotspot/HotspotHub.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/admin',
                name: 'isp-admin',
                component: () => import('../views/Isp/Dashboard/CommandCenter.vue'),
                meta: { permission: 'manage settings' },
            },
            {
            ...
            {
                path: 'isp/subscription/customers/create',
                name: 'isp-subscription-customers-create',
                component: () => import('../views/Isp/Customer/Create.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/subscription/customers/:id/edit',
                name: 'isp-subscription-customers-edit',
                component: () => import('../views/Isp/Customer/Edit.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/contracts',
                name: 'isp-contracts',
                component: () => import('../views/Isp/Customer/Contracts/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
            ...
            },
            {
                path: 'isp/support',
                name: 'isp-support',
                component: () => import('../views/Isp/Settings/Support/Index.vue'),
                meta: { permission: 'manage settings' },
            },
            {
                path: 'isp/support/wizard',
                name: 'isp.support.wizard',
                component: () => import('../views/Isp/Settings/Support/TroubleshootWizard.vue'),
                meta: { permission: 'manage settings' },
            },
            {
            ...
            },
            {
                path: 'isp/infra',
                name: 'isp-infra',
                component: () => import('@/views/Isp/Network/Servers/Index.vue'),
                meta: { title: 'isp.infra.title', auth: true, permission: 'manage settings' }
            },
            {
                path: 'isp/network/olts',
                name: 'isp-olts',
                component: () => import('@/views/Isp/Network/Olt/Index.vue'),
                meta: { title: 'isp.infra.olt.title', auth: true, permission: 'manage settings' }
            },
            {
                path: 'isp/network/olts/:id',
                name: 'isp-olts-show',
                component: () => import('@/views/Isp/Network/Olt/OltDetails.vue'),
                meta: { title: 'isp.infra.olt.title', auth: true, permission: 'manage settings' }
            },
            {
                path: 'isp/network/olt-logs',
                name: 'isp-olt-logs',
                component: () => import('@/views/Isp/Network/Olt/AuditLogs.vue'),
                meta: { title: 'isp.infra.olt.audit.title', auth: true, permission: 'manage settings' }
            },
            {
                path: 'isp/network/olt-discovery',
                name: 'isp-olt-discovery',
                component: () => import('@/views/Isp/Network/Olt/ZtpDiscovery.vue'),
                meta: { title: 'isp.infra.olt.discovery.title', auth: true, permission: 'manage settings' }
            },
            {
                path: 'profile',
                name: 'profile',
