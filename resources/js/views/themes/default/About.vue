<template>
    <div class="min-h-screen bg-background flex items-center justify-center">
        <div class="bg-card p-8 rounded-lg shadow-lg max-w-2xl w-full border border-border">
            ...
            <p class="text-gray-600 mb-4 text-lg leading-relaxed">
                Features included in this Default Theme:
            </p>
            <ul class="list-disc list-inside space-y-2 text-gray-700 mb-8">
                <li>Vue 3 + Vite Powered</li>
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-4 bg-muted rounded-lg">
                        <h3 class="font-bold text-gray-800">Jane Doe</h3>
                        <p class="text-sm text-gray-500">Lead Developer</p>
                    </div>
                    <div class="p-4 bg-muted rounded-lg">
                        <h3 class="font-bold text-gray-800">John Smith</h3>
