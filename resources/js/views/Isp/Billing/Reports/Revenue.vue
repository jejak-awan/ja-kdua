        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card class="border-border/40 shadow-sm bg-primary/5">
                <CardContent class="p-6">
                    <p class="text-xs font-medium text-muted-foreground tracking-tight">{{ $t('isp.admin.analytics.collection_rate', 'Collection Rate') }}</p>
            ...
            <Card class="border-border/40 shadow-sm">
                <CardContent class="p-6">
                    <p class="text-xs font-medium text-muted-foreground tracking-tight">{{ $t('isp.admin.analytics.total_outstanding', 'Total Outstanding') }}</p>
                    <div class="flex items-end justify-between mt-2">
            ...
            <Card class="border-border/40 shadow-sm">
                <CardContent class="p-6">
                    <p class="text-xs font-medium text-muted-foreground tracking-tight">{{ $t('isp.admin.analytics.projected_revenue', 'Growth Target') }}</p>
                    <div class="flex items-end justify-between mt-2">
...
const fetchRevenue = async () => {
    loading.value = true;
    try {
        const response = await api.get('/admin/janet/isp/analytics/revenue');
