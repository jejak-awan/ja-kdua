    ...
    <div class="space-y-6 animate-in fade-in duration-500">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card class="rounded-2xl border-border shadow-sm">
                <CardHeader>
                    <CardTitle class="text-sm font-semibold tracking-tight text-muted-foreground">{{ t('isp.member.usage.realtime_conn') }}</CardTitle>
                </CardHeader>
            ...
            <Card class="rounded-2xl border-border shadow-sm">
                <CardHeader>
                    <CardTitle class="text-sm font-semibold tracking-tight text-muted-foreground text-destructive">{{ t('isp.member.usage.need_speed_title') }}</CardTitle>
                </CardHeader>
                <CardContent>
...
const fetchUsage = async () => {
    loading.value = true;
    try {
        const response = await api.get('/admin/janet/isp/member/usage');
