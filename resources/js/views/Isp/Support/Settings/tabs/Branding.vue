        ...
        <Accordion type="single" class="w-full" collapsible :default-value="'document_identity'">
            ...
            <AccordionItem value="document_identity">
                ...
                <AccordionContent class="pt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div class="bg-muted/30 border rounded-xl p-6 flex flex-col items-center justify-center space-y-4">
                            <div class="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] mb-2">{{ $t('isp.settings.branding.doc_preview') }}</div>
                            
                            <!-- Main Logo Preview container -->
                            <div class="p-8 bg-background border rounded-lg shadow-sm w-full flex items-center justify-center min-h-[120px]">
                                <img 
            ...
            <AccordionItem value="company">
                ...
                <AccordionContent class="pt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-muted/30 border rounded-xl p-8 flex flex-col items-center justify-center space-y-6 text-center">
                            <div class="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] mb-4">{{ $t('isp.settings.branding.invoice_preview') }}</div>
            ...
            <AccordionItem value="invoice_notes">
                ...
                <AccordionContent class="pt-6 space-y-8">
                    <div class="flex items-center space-x-2 bg-muted/20 p-4 rounded-lg border border-dashed">
                        <SettingField
