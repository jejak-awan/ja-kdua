    ...
    <div class="space-y-6 animate-in fade-in duration-500">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex gap-2">
                <Button variant="outline" @click="refreshTopology" class="rounded-xl">
        ...
        <Card class="h-[70vh] w-full overflow-hidden border-border/40 shadow-sm relative bg-muted/5">
            ...
            <!-- Legend -->
            <div class="absolute bottom-4 left-4 bg-background/90 backdrop-blur p-4 rounded-xl border border-border/40 shadow-lg space-y-2 text-xs">
