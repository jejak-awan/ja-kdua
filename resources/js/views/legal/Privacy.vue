        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-card rounded-3xl shadow-2xl shadow-primary/5 overflow-hidden border border-border/40 p-8 sm:p-12 animate-fade-up">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 class="text-3xl font-black tracking-tight text-foreground">Privacy Policy</h1>
                ...
                <div class="prose prose-sm max-w-none text-muted-foreground/90 space-y-6">
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">1. Information We Collect</h2>
                        <p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">2. How We Use Information</h2>
                        <p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">3. Information Sharing</h2>
                        <p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">4. Data Security</h2>
                        <p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">5. Cookies and Tracking</h2>
                        <p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-foreground mb-3 border-b border-border/40 pb-2 mt-8">6. Contact Us</h2>
                        <p>
                            If you have any questions about this Privacy Policy, please contact us at <a :href="`mailto:${contactEmail}`" class="text-primary hover:underline">{{ contactEmail }}</a>.
                        </p>
                    </section>
                </div>
