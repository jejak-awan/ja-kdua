  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-gray-900 dark:to-yellow-900 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl w-full text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
        ...
        <button
          @click="goBack"
          class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-colors"
        >
          <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div v-if="requiredPermissions.length" class="max-w-md mx-auto mb-8">
        <div class="text-left p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
