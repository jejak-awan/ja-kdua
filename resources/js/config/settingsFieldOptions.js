...
export const mailDriverOptions = [
...
export const loginAttemptsOptions = [
...
export const maxConcurrentSessionsOptions = [
...
export const maxUploadSizeOptions = [
...
export function shouldUseDropdown(fieldKey) {
    return getFieldOptions(fieldKey) !== null
}

// Get mail port options based on encryption
export function getMailPortOptions(encryption) {
