...
class VoucherController extends BaseApiController
{
    ...
    public function generate(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'profile_id' => 'nullable|integer|exists:isp_service_profiles,id',
        ]);
    ...
    public function import(Request $request): JsonResponse
    {
        ...
        try {
            /** @var \App\Services\Isp\RadiusIntegration $radius */
            $radius = app(\App\Services\Isp\RadiusIntegration::class);
