...
use App\Services\Isp\Customer\PartnerService;
...
class PartnerController extends BaseApiController
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            // Map statistics to each partner
            $partners->each(fn($partner) => $partner->statistics = $this->partnerService->getStatistics($partner));
