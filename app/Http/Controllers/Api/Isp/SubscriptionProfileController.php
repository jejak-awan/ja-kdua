...
class SubscriptionProfileController extends BaseApiController
{
    /**
    ...
    public function index(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        /** @var \Illuminate\Pagination\LengthAwarePaginator<int, BillingPlan> $profiles */
    ...
    public function store(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $profile = BillingPlan::create($validated);
     ...
     */
    public function show(BillingPlan $subscriptionProfile): \Illuminate\Http\JsonResponse
    {
     ...
     */
    public function update(Request $request, BillingPlan $subscriptionProfile): \Illuminate\Http\JsonResponse
    {
        $validated = $request->validate([
     ...
     */
    public function destroy(BillingPlan $subscriptionProfile): \Illuminate\Http\JsonResponse
    {
