...
use App\Models\Core\TwoFactorAuth;
...
class TwoFactorController extends BaseApiController
{
    ...
    public function generate(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        /** @var \App\Models\Core\TwoFactorAuth $twoFactorAuth */
    ...
    public function verify(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        /** @var \App\Models\Core\User $user */
        $user = $request->user();
        /** @var \App\Models\Core\TwoFactorAuth|null $twoFactorAuth */
    ...
    public function status(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        return $this->success([
            ...
            'enabled_at' => $twoFactorAuth?->enabled_at,
            'global_enabled' => \App\Models\Core\Setting::get('enable_2fa', false),
