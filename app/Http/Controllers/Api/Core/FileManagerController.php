...
use App\Models\Core\DeletedFile;
...
class FileManagerController extends BaseApiController
{
    ...
    public function delete(Request $request)
    {
        ...
        if ($permanent) {
            // Find media if any
            $media = \App\Models\Core\Media::where(function ($q) use ($path) {
                $q->where('path', $path)
                    ->orWhere('path', '/'.$path);
            })->first();
    ...
    public function deleteFolder(Request $request)
    {
        ...
        try {
            ...
            $searchPath = $path.'/';
            $mediaItems = \App\Models\Core\Media::where('path', 'like', $searchPath.'%')
    ...
    public function restore(Request $request)
    {
        ...
        if ($deletedFile->type === 'file') {
            try {
                $media = \App\Models\Core\Media::withTrashed()
            ...
            try {
                ...
                $mediaItems = \App\Models\Core\Media::withTrashed()
    ...
    public function emptyTrash(Request $request)
    {
        ...
        $deletedRecords = \App\Models\Core\DeletedFile::all();
        $disksToClean = [];
        ...
        \App\Models\Core\DeletedFile::query()->delete();
