...
class AuthController extends BaseApiController
{
    ...
    public function login(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if (\App\Models\Core\Setting::get('enable_captcha', false) &&
            \App\Models\Core\Setting::get('captcha_on_login', true) &&
        ...
        try {
            if (class_exists(\App\Models\Core\ActivityLog::class)) {
                \App\Models\Core\ActivityLog::log('login', null, [], $user, 'User logged in');
            }
        } catch (\Exception $e) {
        ...
        $singleSession = \App\Models\Core\Setting::get('single_session_enabled', false);
        $maxSessionsRaw = \App\Models\Core\Setting::get('max_concurrent_sessions', 0);
        ...
        if ($singleSession) {
            ...
            if ($revokedCount > 0) {
                ...
                \App\Models\Core\SecurityLog::log(
                    'session_invalidated',
                    $user,
                    $ipAddress,
            ...
            try {
                ...
                \App\Services\Core\SessionManager::setLifetimeForUser($user);
    ...
    public function register(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $registrationEnabled = \App\Models\Core\Setting::get('enable_registration', true);
        ...
        try {
            // Verify Captcha
            if (\App\Models\Core\Setting::get('enable_captcha', false) && \App\Models\Core\Setting::get('captcha_on_register', true)) {
                $captchaService = new \App\Services\Core\CaptchaService;
    ...
    public function logout(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        // Log activity
        if ($user) {
            \App\Models\Core\ActivityLog::log('logout', null, [], $user, 'User logged out');
        }
    ...
    public function resetPassword(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        // Log activity
        \App\Models\Core\ActivityLog::log('password_reset', null, [], $user, 'Password reset via email');
