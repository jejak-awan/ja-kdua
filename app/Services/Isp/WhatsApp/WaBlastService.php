...
class WaBlastService
{
     ...
     * @return LengthAwarePaginator<int, WaTemplate>
     */
     ...
     */
    public function createTemplate(array $data): WaTemplate
    {
     ...
     * @param  array<string, mixed>  $data
     */
    public function updateTemplate(WaTemplate $template, array $data): WaTemplate
    {
    ...
    /**
     * @param  array<string, mixed>  $filters
     * @return LengthAwarePaginator<int, WaBlast>
     */
    public function listBlasts(array $filters = []): LengthAwarePaginator
    {
        $query = WaBlast::with('template');
     ...
     * @param  array<string, mixed>  $data
     */
    public function createBlast(array $data): WaBlast
    {
        ...
        if (isset($data['template_id']) && is_numeric($data['template_id'])) {
            /** @var WaTemplate|null $template */
            $template = WaTemplate::find((int) $data['template_id']);
            if ($template !== null && $message === '') {
                $message = $template->body;
            }
        }

        return WaBlast::create([
     ...
     */
    public function sendBlast(WaBlast $blast): WaBlast
    {
        $blast->update([
            'status' => 'processing',
            'started_at' => now(),
    ...
    /**
     * @param  array<string, mixed>  $filters
     * @return LengthAwarePaginator<int, WaSchedule>
     */
    public function listSchedules(array $filters = []): LengthAwarePaginator
    {
        $query = WaSchedule::with('template');
     ...
     * @param  array<string, mixed>  $data
     */
    public function createSchedule(array $data): WaSchedule
    {
     ...
     * @param  array<string, mixed>  $data
     */
    public function updateSchedule(WaSchedule $schedule, array $data): WaSchedule
    {
     ...
     */
    protected function calculateNextRun(WaSchedule $schedule): void
    {
    ...
    {
        $dueSchedules = WaSchedule::where('is_active', true)
