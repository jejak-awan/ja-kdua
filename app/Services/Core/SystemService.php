...
class SystemService
{
    ...
    public function getQueueHealth(): array
    {
        ...
        if ($driver !== 'sync') {
            try {
                \App\Jobs\Core\QueueHeartbeatJob::dispatch();
            } catch (\Throwable $e) {
    ...
    public function getStatistics(): array
    {
        ...
        try {
            ...
            $stats = [
                ...
                'total_contents' => \App\Models\Core\Content::count(),
                'total_users' => \App\Models\Core\User::count(),
                'total_media' => \App\Models\Core\Media::count(),
                'total_visits' => $totalVisits,
                // Detailed nested data (for extended use)
                'contents' => [
                    'total' => \App\Models\Core\Content::count(),
                    'published' => \App\Models\Core\Content::where('status', 'published')->count(),
                    'draft' => \App\Models\Core\Content::where('status', 'draft')->count(),
                    'archived' => \App\Models\Core\Content::where('status', 'archived')->count(),
                ],
                'users' => [
                    'total' => \App\Models\Core\User::count(),
                    'verified' => \App\Models\Core\User::whereNotNull('email_verified_at')->count(),
                ],
                'media' => [
                    'total' => \App\Models\Core\Media::count(),
                    'total_size' => \App\Models\Core\Media::sum('size'),
                ],
                'categories' => \App\Models\Core\Category::count(),
                'tags' => \App\Models\Core\Tag::count(),
                'comments' => \App\Models\Core\Comment::count(),
                'forms' => \App\Models\Core\Form::count(),
                'form_submissions' => \App\Models\Core\FormSubmission::count(),
                'total_email_templates' => \App\Models\Core\EmailTemplate::count(),
                'newsletter_subscribers' => \App\Models\Core\NewsletterSubscriber::count(),
                'email' => [
                    'templates' => \App\Models\Core\EmailTemplate::count(),
                    'subscribers' => \App\Models\Core\NewsletterSubscriber::count(),
