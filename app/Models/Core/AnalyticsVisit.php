...
{
    /** @use HasFactory<\Database\Factories\Core\AnalyticsVisitFactory> */
    use HasFactory;
    ...
    public function content(): ?\App\Models\Core\Content
    {
        ...
        /** @var \App\Models\Core\Content|null */
        return \App\Models\Core\Content::where('slug', $slug)->first();
    }
