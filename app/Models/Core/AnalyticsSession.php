 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Core\AnalyticsVisit[] $visits
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Core\AnalyticsEvent[] $events
 */
class AnalyticsSession extends Model
{
    /** @use HasFactory<\Database\Factories\Core\AnalyticsSessionFactory> */
    use HasFactory;
    ...
    public static function getLocation(?string $ipAddress): array
    {
        ...
        $geoService = app(\App\Services\Core\GeoIpService::class);
