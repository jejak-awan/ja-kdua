...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // 2. Service Requests (Upgrade/Relocation)
        ...
        Schema::create('isp_wa_templates', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        // 5. WhatsApp Blast Batches
        Schema::create('isp_wa_blasts', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->foreignId('template_id')->nullable()->constrained('isp_wa_templates')->nullOnDelete();
            $table->text('message');
        ...
        // 6. WhatsApp Recipient Logs
        Schema::create('isp_wa_blast_logs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('blast_id')->constrained('isp_wa_blasts')->cascadeOnDelete();
            $table->string('phone');
        ...
        // 7. WhatsApp Notification Schedules (Automated)
        Schema::create('isp_wa_schedules', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->foreignId('template_id')->nullable()->constrained('isp_wa_templates')->nullOnDelete();
            $table->string('target_filter');
        ...
        // 8. Printing Templates (Vouchers/Invoices)
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('isp_wa_schedules');
        Schema::dropIfExists('isp_wa_blast_logs');
        Schema::dropIfExists('isp_wa_blasts');
        Schema::dropIfExists('isp_wa_templates');
